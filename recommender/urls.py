...
urlpatterns = [
    ...
    re_path(r'^sim/item/(?P<content_id>\w+)/$',
        views.recs_item_similarity, name='recs_item_similarity'),
    ...
    re_path(r'^als/user/(?P<user_id>\w+)/$',
        views.recs_als, name='recs_als'),
    re_path(r'^svd/user/(?P<user_id>\w+)/$',
        views.recs_svd, name='recs_svd'),
    re_path(r'^fwls/user/(?P<user_id>\w+)/$',
        views.recs_fwls, name='recs_fwls'),
    re_path(r'^bpr/user/(?P<user_id>\w+)/$',
        views.recs_bpr, name='recs_bpr'),
    re_path(r'^pop/item/(?P<content_id>\w+)/$',
